...
pub(crate) fn parse_ipv4_address(ip_address_: &[u8]) -> Result<IpAddrRef<'_>, AddrParseError> {
...
pub(crate) fn parse_ipv6_address(ip_address_: &[u8]) -> Result<IpAddrRef<'_>, AddrParseError> {
